...
mod tests {
    ...
    // Epoch handling
    #[case("1!1.0.0", pep_zerv_1_0_0_epoch_1())]
    #[case("5!1.0.0", pep_zerv_1_0_0_epoch_5())]
    #[case("999!1.0.0", pep_zerv_1_0_0_epoch_999())]
    // Post handling
    #[case("1.0.0.post5", pep_zerv_1_0_0_post_5())]
    #[case("1.0.0.post0", pep_zerv_1_0_0_post_0())]
    // Dev handling
    #[case("1.0.0.dev0", pep_zerv_1_0_0_dev_0())]
    #[case("1.0.0.dev10", pep_zerv_1_0_0_dev_10())]
    // Epoch + pre-release combinations
    #[case("2!1.0.0a1", pep_zerv_1_0_0_epoch_2_alpha_1())]
    #[case("3!1.0.0b2", pep_zerv_1_0_0_epoch_3_beta_2())]
    #[case("1!1.0.0rc5", pep_zerv_1_0_0_epoch_1_rc_5())]
    #[case("4!1.0.0a0", pep_zerv_1_0_0_epoch_4_alpha())]
    // Post + dev combinations
    #[case("1.0.0.post1.dev2", pep_zerv_1_0_0_post_1_dev_2())]
    // Pre-release + post combinations
    #[case("1.0.0a1.post2", pep_zerv_1_0_0_alpha_1_post_2())]
    #[case("1.0.0b3.post1", pep_zerv_1_0_0_beta_3_post_1())]
    #[case("1.0.0rc2.post5", pep_zerv_1_0_0_rc_2_post_5())]
    // Pre-release + dev combinations
    #[case("1.0.0a1.dev2", pep_zerv_1_0_0_alpha_1_dev_2())]
    #[case("1.0.0b2.dev1", pep_zerv_1_0_0_beta_2_dev_1())]
    #[case("1.0.0rc1.dev3", pep_zerv_1_0_0_rc_1_dev_3())]
    // Triple combinations
    #[case("1.0.0a1.post2.dev3", pep_zerv_1_0_0_alpha_1_post_2_dev_3())]
    #[case("1.0.0b2.post3.dev1", pep_zerv_1_0_0_beta_2_post_3_dev_1())]
    #[case("1.0.0rc1.post1.dev1", pep_zerv_1_0_0_rc_1_post_1_dev_1())]
    // Epoch + post + dev combinations
    #[case("2!1.0.0.post1.dev3", pep_zerv_1_0_0_epoch_2_post_1_dev_3())]
    #[case("1!1.0.0.post1.dev2", pep_zerv_1_0_0_epoch_1_post_1_dev_2())]
    // All components together
    #[case("3!1.0.0a1.post2.dev1", pep_zerv_1_0_0_epoch_3_alpha_1_post_2_dev_1())]
    #[case("1!1.0.0b2.post1.dev3", pep_zerv_1_0_0_epoch_1_beta_2_post_1_dev_3())]
    // With build metadata
    #[case("1!1.0.0+build.123", pep_zerv_1_0_0_epoch_1_build())]
    #[case("1.0.0.post1+build.456", pep_zerv_1_0_0_post_1_build())]
    #[case("1.0.0.dev2+build.789", pep_zerv_1_0_0_dev_2_build())]
    #[case("2!1.0.0a1+build.abc", pep_zerv_1_0_0_epoch_2_alpha_1_build())]
    // Complex local version identifiers
    #[case("1.0.0+foo.bar.123", pep_zerv_1_0_0_complex_local())]
    #[case(
