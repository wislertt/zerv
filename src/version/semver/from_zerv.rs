...
mod tests {
    ...
    #[rstest]
    #[case(ZervFixture::sem_zerv_1_2_3(), "1.2.3")]
    #[case(ZervFixture::sem_zerv_1_0_0_alpha_1(), "1.0.0-alpha.1")]
    #[case(ZervFixture::sem_zerv_1_0_0_something_1(), "1.0.0-something.1")]
    #[case(ZervFixture::sem_zerv_1_0_0_build_123(), "1.0.0+build.123")]
    #[case(
    ...
    #[case(ZervFixture::sem_zerv_1_0_0_alpha_1_beta_2(), "1.0.0-alpha.1.beta.2")]
    #[case(
        ZervFixture::sem_zerv_1_0_0_rc_1_alpha_2_beta_3(),
        "1.0.0-rc.1.alpha.2.beta.3"
    )]
    #[case(ZervFixture::sem_zerv_1_0_0_rc_alpha_1(), "1.0.0-rc.alpha.1")]
    #[case(
    ...
    #[case(ZervFixture::sem_zerv_1_0_0_foo_1_alpha(), "1.0.0-foo.1.alpha")]
    #[case(ZervFixture::sem_zerv_1_0_0_bar_2_beta(), "1.0.0-bar.2.beta")]
    // CalVer patterns
    #[case(calver_yy_mm_patch(), "24.3.5")]
    #[case(calver_yyyy_mm_patch(), "2024.3.1")]
    #[case(calver_with_timestamp_build(), "1.0.0+2024.3.16")]
    #[case(ZervFixture::sem_zerv_core_overflow_1_2(), "1.2.0")]
    #[case(ZervFixture::sem_zerv_core_overflow_1_2_3_4_5(), "1.2.3-4.5")]
    // Epoch handling
    #[case(ZervFixture::zerv_1_0_0_with_epoch(1), "1.0.0-epoch.1")]
    #[case(ZervFixture::zerv_1_0_0_with_epoch(5), "1.0.0-epoch.5")]
    #[case(ZervFixture::zerv_1_0_0_with_epoch(0), "1.0.0-epoch.0")]
    #[case(ZervFixture::zerv_1_0_0_with_epoch(999), "1.0.0-epoch.999")]
    // Post handling
    #[case(ZervFixture::zerv_1_0_0_with_post(1), "1.0.0-post.1")]
    #[case(ZervFixture::zerv_1_0_0_with_post(5), "1.0.0-post.5")]
    #[case(ZervFixture::zerv_1_0_0_with_post(0), "1.0.0-post.0")]
    // Dev handling
    #[case(ZervFixture::zerv_1_0_0_with_dev(1), "1.0.0-dev.1")]
    #[case(ZervFixture::zerv_1_0_0_with_dev(0), "1.0.0-dev.0")]
    #[case(ZervFixture::zerv_1_0_0_with_dev(10), "1.0.0-dev.10")]
    ...
    #[case(ZervFixture::zerv_1_0_0_with_post_and_dev(1, 2), "1.0.0-post.1.dev.2")]
    #[case(ZervFixture::zerv_1_0_0_with_dev_and_post(3, 4), "1.0.0-dev.3.post.4")]
    ...
    #[case(ZervFixture::zerv_1_0_0_with_dev_and_build(2), "1.0.0-dev.2+build.789")]
    #[case(
    ...
    #[case(
        ZervFixture::zerv_1_0_0_with_foo_epoch_and_alpha(1, 2),
        "1.0.0-epoch.1.foo.alpha.2"
    )]
    #[case(
    ...
    #[case(
        ZervFixture::zerv_1_0_0_with_bar_dev_and_epoch(1, 2),
        "1.0.0-epoch.2.bar.dev.1"
    )]
    // VarField build metadata tests
    #[case(ZervFixture::sem_zerv_1_0_0_with_branch(), "1.0.0+dev")]
    #[case(ZervFixture::sem_zerv_1_0_0_with_distance(), "1.0.0+5")]
    #[case(ZervFixture::sem_zerv_1_0_0_with_commit_hash(), "1.0.0+abc123")]
    #[case(
        ZervFixture::sem_zerv_1_0_0_with_branch_distance_hash(),
        "1.0.0+dev.3.def456"
    )]
    #[case(ZervFixture::sem_zerv_1_0_0_with_none_varfields(), "1.0.0")]
