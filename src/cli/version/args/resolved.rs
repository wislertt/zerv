...
impl ResolvedOverrides {
    fn resolve(overrides: &OverridesConfig, zerv: &Zerv) -> Result<Self, ZervError> {
        Ok(ResolvedOverrides {
            ...
            tag_version: overrides.common.tag_version.clone(),
            distance: overrides.common.distance,
            dirty: overrides.common.dirty,
            no_dirty: overrides.common.no_dirty,
            clean: overrides.common.clean,
            bumped_branch: overrides.common.bumped_branch.clone(),
            bumped_commit_hash: overrides.common.bumped_commit_hash.clone(),
            bumped_timestamp: overrides.common.bumped_timestamp,

            // Version component overrides (resolve templates)
            major: Self::resolve_option_template(&overrides.common.major, zerv)?,
            minor: Self::resolve_option_template(&overrides.common.minor, zerv)?,
            patch: Self::resolve_option_template(&overrides.common.patch, zerv)?,
            epoch: Self::resolve_option_template(&overrides.common.epoch, zerv)?,
            post: Self::resolve_option_template(&overrides.common.post, zerv)?,
