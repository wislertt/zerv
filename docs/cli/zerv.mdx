...
The docs site serves machine-readable endpoints alongside the HTML pages:

| Endpoint                                | Purpose                                              |
| --------------------------------------- | ---------------------------------------------------- |
| `https://zerv.wisl.dev/llms.txt`        | Docs index for AI agents                             |
| `https://zerv.wisl.dev/llms-full.txt`   | All pages in one file                                |
| `https://zerv.wisl.dev/skill.md`        | Agent skill file (`npx skills add https://zerv.wisl.dev`) |
| `https://zerv.wisl.dev/mcp`             | Search MCP server for MCP clients                    |
| Any page URL + `.md`                    | Markdown export, e.g. `/cli/flow.md`                 |

`zerv --help` advertises these endpoints in its afterword.
