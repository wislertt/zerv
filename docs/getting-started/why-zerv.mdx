...
Release tools answer _what version is this release?_ CI builds artifacts on every push, and
those builds need versions long before a release exists. zerv answers _what version is this
exact Git state?_

The payoff: [trunk-based development where every branch is still e2e-testable](https://wisl.dev/blog/stupidly-simple-branching/).
...
The [zerv-flow](https://github.com/wislertt/example-zerv-flow) demonstration repo shows the full
