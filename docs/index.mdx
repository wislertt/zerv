...
**Automatic versioning for every commit.** Generate semantic versions from any commit across
all branches, or a dirty working directory, with pre-release handling and format support for
any CI/CD workflow.
